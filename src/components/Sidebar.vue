<template lang="html">
  <div class="sidebar" data-color="purple" data-image="./static/img/sidebar-4.jpg">
      ...
      <ul class="nav">
        ...
        <li>
          <a href="table.html"><i class="pe-7s-note2"></i>
            <p>Table List</p>
          </a>
        </li>
        <li>
          <a href="typography.html"><i class="pe-7s-news-paper"></i>
            <p>Typography</p>
          </a>
        </li>
        <li>
          <a href="icons.html"><i class="pe-7s-science"></i>
            <p>Icons</p>
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="notifications.html"><i class="pe-7s-bell"></i>
            <p>Notifications</p>
          </a>
        </li>
      </ul>
